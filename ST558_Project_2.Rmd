...
g + geom_bar(aes(fill = symbol), position = "dodge")+
  ...
  ggtitle("Barplot for the summary for different stock sticker")
...
g + geom_boxplot(fill = "orange")+
  labs(x = "Stock Stickers", y = "Stock price change per day ")+
  ggtitle("Boxplot for stock price change for specific stock sticker")
```
...
g + geom_point()+labs(x = "Date", y = "Close price ", color ="Stock Sticker")+
...
g + geom_boxplot(fill = "green")+ geom_point(aes(color = symbol),position = "jitter") +
  labs(x = "Stock Stickers", y = "Volume", color = "Stock Sticker")+
  ggtitle("Figure for volume for specific stock sticker")
