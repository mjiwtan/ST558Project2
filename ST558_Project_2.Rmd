...
This function is for interacting with the Tickers endpoint. It can be used to query all ticker symbols which are supported by this Financial API. This currently includes Stocks/Equities, Crypto, and Forex.  
...
Function Call for exploratory data analysis. In this part, I pulled the open,close and afterhours prices of several stocks(AAPL,AXP and AAL) between certain date(10/11/2021 - 10/22/2021).  
